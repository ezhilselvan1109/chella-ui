...
export default function App() {
  ...
  const guideItems = filteredNav.filter((i) => i.category === "Guide");
  const componentItems = filteredNav.filter((i) => i.category === "Components");
  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col font-sans transition-colors duration-200">
      {/* Top Navigation */}
      <header className="sticky top-0 z-40 border-b border-border bg-background/90 backdrop-blur-md px-4 sm:px-6 py-3 flex items-center justify-between shadow-xs">
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2.5">
            <div className="w-8 h-8 rounded-chellaa-md bg-primary text-primary-foreground flex items-center justify-center font-black text-sm shadow-xs">
              C
            </div>
            <div className="flex items-center gap-2">
              <span className="font-extrabold tracking-tight text-sm sm:text-base">Chellaa UI</span>
              <Badge variant="primary" size="small" className="font-semibold text-[10px] px-1.5 py-0.5">
                v0.1.0
              </Badge>
              <Badge variant="outline" size="small" className="hidden sm:inline-flex text-[10px] px-1.5 py-0.5 text-muted-foreground">
                35 Components
              </Badge>
            </div>
          </div>
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          {/* Theme Switcher */}
          <div className="flex items-center bg-muted/60 p-1 rounded-chellaa-md border border-border">
            <button
              onClick={() => setTheme("light")}
              title="Light theme"
              className={`p-1.5 rounded-chellaa-sm transition-colors ${
                theme === "light" ? "bg-background text-primary shadow-xs" : "text-muted-foreground hover:text-foreground"
              }`}
            >
            ...
            <button
              ...
              title="Dark theme"
              className={`p-1.5 rounded-chellaa-sm transition-colors ${
                theme === "dark" ? "bg-background text-primary shadow-xs" : "text-muted-foreground hover:text-foreground"
              }`}
            >
            ...
            <button
              ...
              title="System theme"
              className={`p-1.5 rounded-chellaa-sm transition-colors ${
                theme === "system" ? "bg-background text-primary shadow-xs" : "text-muted-foreground hover:text-foreground"
              }`}
            >
      ...
      >
        <Drawer.Header>
          <div className="flex items-center gap-2.5">
            <div className="w-7 h-7 rounded-chellaa-md bg-primary text-primary-foreground flex items-center justify-center font-bold text-xs">
              C
            </div>
            <div>
              <Drawer.Title>Chellaa UI Docs</Drawer.Title>
              <Drawer.Description>Documentation & Component Reference</Drawer.Description>
            </div>
          </div>
        </Drawer.Header>
        <Drawer.Body className="space-y-5 px-3 py-4">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-8 pr-3 py-2 text-xs bg-muted/50 rounded-chellaa-md border border-border outline-none focus:border-primary focus:ring-1 focus:ring-primary"
            />
          </div>

          <div className="space-y-4">
            <div>
              <div className="flex items-center justify-between text-[11px] font-bold uppercase tracking-wider text-muted-foreground mb-2 px-2">
                <span className="flex items-center gap-1.5"><BookOpen className="w-3 h-3" /> Getting Started</span>
                <span className="text-[10px] text-muted-foreground">{guideItems.length}</span>
              </div>
              <div className="space-y-0.5">
                {guideItems.map((item) => (
                  <button
                    ...
                    className={`w-full text-left px-3 py-2 rounded-chellaa-md text-xs font-medium transition-colors flex items-center justify-between ${
            ...
            <div>
              <div className="flex items-center justify-between text-[11px] font-bold uppercase tracking-wider text-muted-foreground mb-2 px-2">
                <span className="flex items-center gap-1.5"><Layers className="w-3 h-3" /> Components</span>
                <span className="text-[10px] text-muted-foreground">{componentItems.length}</span>
              </div>
              <div className="space-y-0.5">
      ...
      <div className="flex-1 flex max-w-7xl w-full mx-auto">
        ...
        <aside className="w-64 lg:w-72 border-r border-border/80 p-5 space-y-6 shrink-0 hidden md:block sticky top-[57px] h-[calc(100vh-57px)] overflow-y-auto">
          <div className="relative">
            ...
            <input
              ...
              value={searchQuery}
              onChange={(e) => setSearchQuery(e.target.value)}
              className="w-full pl-9 pr-3 py-2 text-xs sm:text-sm bg-muted/40 hover:bg-muted/60 focus:bg-background rounded-chellaa-md border border-border outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all placeholder:text-muted-foreground/70"
            />
          </div>

          <div className="space-y-6">
            <div>
              <div className="text-[11px] font-bold uppercase tracking-wider text-muted-foreground/90 mb-2 px-1">
                GETTING STARTED
              </div>
              <div className="space-y-1">
                {guideItems.map((item) => (
                  <button
                    ...
                    className={`w-full text-left px-3 py-2 rounded-chellaa-md text-xs sm:text-sm transition-colors ${
                      activeSection === item.id
                        ? "bg-primary/10 text-primary font-semibold"
        ...
        {/* Main Doc View */}
        <main className="flex-1 min-w-0 p-4 sm:p-8 lg:p-10 max-w-4xl space-y-10">
          {/* Breadcrumb Header */}
          <div className="flex items-center gap-1.5 text-xs text-muted-foreground pb-2 border-b border-border/50">
            <span>Chellaa UI</span>
            <ChevronRight className="w-3 h-3 opacity-60" />
            <span>{currentItem?.category || "Documentation"}</span>
            <ChevronRight className="w-3 h-3 opacity-60" />
            <span className="font-semibold text-foreground">{currentItem?.title}</span>
          </div>
          ...
          {activeSection === "getting-started" && (
            <div className="space-y-8">
              <div className="space-y-2">
                ...
                <h1 className="text-3xl font-extrabold tracking-tight">Chellaa UI</h1>
              ...
              <div className="space-y-3">
                ...
                <div className="relative rounded-chellaa-lg bg-muted/60 border border-border p-4 font-mono text-xs text-foreground flex items-center justify-between">
                  <code>npm install @chellaa/ui</code>
                  <button
                    onClick={() => copyToClipboard("npm install @chellaa/ui", "install")}
              ...
              <div className="space-y-3">
                ...
                <div className="relative rounded-chellaa-lg bg-card border border-border p-4 font-mono text-xs text-foreground overflow-x-auto">
                  <pre>{`// main.tsx
import React from "react";
import ReactDOM from "react-dom/client";
import { ThemeProvider } from "@chellaa/ui";
import "@chellaa/ui/styles.css"; // Bundled Tailwind CSS styles
import App from "./App";
    ...
    <ThemeProvider defaultTheme="system">
      <App />
              ...
              <div className="space-y-3">
                ...
                <div className="relative rounded-chellaa-lg bg-card border border-border p-4 font-mono text-xs text-foreground overflow-x-auto">
                  <pre>{`// App.tsx
import { Button, Input, Modal, Select, Table, Card } from "@chellaa/ui";
            ...
            <div className="space-y-8">
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground text-sm">
                  Chellaa UI uses an HSL CSS variable architecture. This empowers seamless light/dark mode toggling and runtime brand palette customization without rebuilding CSS.
                </p>
              </div>
              ...
              <Card variant="outlined">
                ...
                <Card.Content>
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-xs">
                    <div className="p-3 rounded-chellaa-md bg-primary/10 border border-primary/20">
                      <div className="font-bold text-primary">bg-primary</div>
                      <div className="text-muted-foreground">Primary Brand Action</div>
                    </div>
                    <div className="p-3 rounded-chellaa-md bg-secondary border border-border">
                    ...
                    <div className="p-3 rounded-chellaa-md bg-success/15 border border-success/25">
                      <div className="font-bold text-success">bg-success</div>
                      <div className="text-muted-foreground">Positive Alerts</div>
                    </div>
                    <div className="p-3 rounded-chellaa-md bg-danger/15 border border-danger/25">
          ...
          {activeSection === "button" && (
            <div className="space-y-8">
              ...
              <div className="space-y-3">
                ...
                <div className="p-8 rounded-chellaa-lg border border-border bg-card flex flex-col items-center justify-center gap-6">
                  <Button
                    variant={btnVariant}
                    size={btnSize}
                    loading={btnLoading}
              ...
              <div className="space-y-2">
                ...
                <div className="rounded-chellaa-lg bg-card border border-border p-4 font-mono text-xs">
  ...
  Interactive Button
          ...
          {activeSection === "input" && (
            <div className="space-y-8">
              ...
              <div className="space-y-3">
                <div className="text-sm font-bold">Interactive Preview</div>
                <div className="p-8 rounded-chellaa-lg border border-border bg-card max-w-md mx-auto space-y-4">
                  <Input
          ...
          {activeSection === "textarea" && (
            <div className="space-y-8">
              ...
              <div className="space-y-3">
                <div className="text-sm font-bold">Interactive Preview</div>
                <div className="p-8 rounded-chellaa-lg border border-border bg-card max-w-md mx-auto space-y-6">
                  <Textarea
              ...
              <div className="space-y-3">
                ...
                <div className="relative rounded-chellaa-lg bg-muted/60 border border-border p-4 font-mono text-xs text-foreground">
...
export default function IncidentReport() {
  ...
  return (
    ...
    />
              ...
              <div className="space-y-3">
                <div className="text-sm font-bold">API Reference</div>
                <div className="rounded-chellaa-lg border border-border overflow-hidden">
    ...
    />
          ...
          {activeSection === "switch" && (
            <div className="space-y-8">
              ...
              <div className="p-4 rounded-chellaa-md bg-primary/10 border border-primary/20 text-xs leading-relaxed space-y-1">
              ...
              <div className="space-y-3">
                <div className="text-sm font-bold">Interactive Preview</div>
                <div className="p-8 rounded-chellaa-lg border border-border bg-card max-w-md mx-auto space-y-5">
                  <Switch
    ...
    />
          ...
          {activeSection === "modal" && (
            <div className="space-y-8">
              ...
              <div className="space-y-3">
                <div className="text-sm font-bold">Interactive Preview</div>
                <div className="p-8 rounded-chellaa-lg border border-border bg-card flex justify-center">
          ...
          {activeSection === "card" && (
            <div className="space-y-8">
              ...
              <div className="space-y-3">
                ...
                <div className="relative rounded-chellaa-lg bg-muted/60 border border-border p-4 font-mono text-xs text-foreground">
                  <pre className="overflow-x-auto">
{`import { Card, Button } from "@chellaa/ui";
        ...
        <Button size="small">View Metrics</Button>
          ...
          {activeSection === "badge" && (
            <div className="space-y-8">
              ...
              <div className="space-y-3">
                <div className="text-sm font-bold">Interactive Preview</div>
                <div className="p-6 rounded-chellaa-lg border border-border bg-card space-y-4">
                  <div className="space-y-2">
        ...
        Production
          ...
          {activeSection === "table" && (
            <div className="space-y-8">
              ...
              <div className="space-y-3">
                <div className="text-sm font-bold">Interactive Preview</div>
                <div className="rounded-chellaa-lg border border-border bg-card p-4">
                  <Table
                    bordered
                    columns={[
  ...
  return <Table columns={columns} dataSource={dataSource} bordered striped />;
          ...
          {activeSection === "tooltip" && (
            <div className="space-y-8">
              ...
              <div className="space-y-3">
                <div className="text-sm font-bold">Interactive Preview</div>
                <div className="p-12 rounded-chellaa-lg border border-border bg-card max-w-lg mx-auto flex flex-wrap items-center justify-center gap-6">
          ...
          {activeSection === "popover" && (
            <div className="space-y-8">
              ...
              <div className="space-y-3">
                ...
                <div className="relative rounded-chellaa-lg bg-muted/60 border border-border p-4 font-mono text-xs text-foreground">
                  <pre className="overflow-x-auto">
{`import { Popover, Button, Switch } from "@chellaa/ui";
          ...
          {activeSection === "dropdown" && (
            <div className="space-y-8">
              ...
              <div className="space-y-3">
                ...
                <div className="relative rounded-chellaa-lg bg-muted/60 border border-border p-4 font-mono text-xs text-foreground">
                  <pre className="overflow-x-auto">
{`import { Dropdown, Button } from "@chellaa/ui";
          ...
          {activeSection === "toast" && (
            <div className="space-y-8">
              ...
              <div className="space-y-3">
                ...
                <div className="p-8 rounded-chellaa-lg border border-border bg-card max-w-xl mx-auto flex flex-wrap items-center justify-center gap-3">
                  <Button
                    variant="primary"
                    onClick={() =>
              ...
              <div className="space-y-3">
                ...
                <div className="relative rounded-chellaa-lg bg-muted/60 border border-border p-4 font-mono text-xs text-foreground">
                  <pre className="overflow-x-auto">
{`import { ToastProvider, useToast, Button } from "@chellaa/ui";
  ...
  return <Button onClick={handleDeploy}>Deploy App</Button>;
          ...
          {activeSection === "tabs" && (
            <div className="space-y-8">
              ...
              <div className="space-y-3">
                <div className="text-sm font-bold">Interactive Preview</div>
                <div className="p-8 rounded-chellaa-lg border border-border bg-card max-w-xl mx-auto space-y-6">
                  {/* Line Variant */}
                  <Tabs defaultValue="specs" variant="line">
                    ...
                    <Tabs.Content value="telemetry" className="p-3 text-xs text-muted-foreground bg-muted/40 rounded-chellaa-md">
                  ...
                  <div className="pt-4 border-t border-border">
                    ...
                    <Tabs defaultValue="day" variant="pill">
                      ...
                      <Tabs.Content value="day" className="p-3 text-xs text-muted-foreground bg-muted/30 rounded-chellaa-md">
                        24-Hour Traffic: 42,910 req/sec | Error Rate: 0.001%
                      </Tabs.Content>
                      <Tabs.Content value="week" className="p-3 text-xs text-muted-foreground bg-muted/30 rounded-chellaa-md">
                        7-Day Traffic: 310,400 req/sec | Error Rate: 0.003%
                      </Tabs.Content>
                      <Tabs.Content value="month" className="p-3 text-xs text-muted-foreground bg-muted/30 rounded-chellaa-md">
          ...
          {activeSection === "accordion" && (
            <div className="space-y-8">
                  ...
                  <div>
                    ...
                    <Accordion type="single" collapsible defaultValue="item-1">
                      <Accordion.Item value="item-1">
                        ...
                        <Accordion.Content>
                          Chellaa UI is a high-performance, accessible React component library inspired by Ant Design, Material UI, and Radix UI, styled with customizable Tailwind CSS tokens.
                        </Accordion.Content>
                      </Accordion.Item>
                      ...
                      <Accordion.Item value="item-2">
                        ...
                        <Accordion.Content>
                          Chellaa UI leverages HSL CSS variables configured in Tailwind. Switching between Light, Dark, System, and brand presets updates token values instantaneously with zero layout thrashing.
                        </Accordion.Content>
                      </Accordion.Item>

                      <Accordion.Item value="item-3">
                        <Accordion.Trigger>Is Chellaa UI enterprise ready?</Accordion.Trigger>
                        <Accordion.Content>
              ...
              <div className="space-y-3">
                ...
                <div className="relative rounded-chellaa-lg bg-muted/60 border border-border p-4 font-mono text-xs text-foreground">
                  <pre className="overflow-x-auto">
{`import { Accordion } from "@chellaa/ui";
  ...
  return (
    <Accordion type="single" collapsible defaultValue="q1">
      ...
      <Accordion.Item value="q2">
        ...
        <Accordion.Content>Chellaa UI is written 100% in TypeScript.</Accordion.Content>
      </Accordion.Item>
    </Accordion>
  );
}
          ...
          {activeSection === "skeleton" && (
            <div className="space-y-8">
              ...
              <div className="space-y-3">
                ...
                <div className="p-8 rounded-chellaa-lg border border-border bg-card max-w-xl mx-auto space-y-6">
                  {/* Card Placeholder */}
                  <div className="space-y-3 p-4 border border-border rounded-chellaa-lg bg-card">
                    <div className="flex items-center gap-3">
              ...
              <div className="space-y-3">
                ...
                <div className="relative rounded-chellaa-lg bg-muted/60 border border-border p-4 font-mono text-xs text-foreground">
                  <pre className="overflow-x-auto">
{`import { Skeleton, Card } from "@chellaa/ui";
          ...
          {activeSection === "progress" && (
            <div className="space-y-8">
              ...
              <div className="space-y-3">
                ...
                <div className="relative rounded-chellaa-lg bg-muted/60 border border-border p-4 font-mono text-xs text-foreground">
                  <pre className="overflow-x-auto">
{`import { Progress, CircularProgress } from "@chellaa/ui";
...
/>`}
          ...
          {activeSection === "drawer" && (
            <div className="space-y-8">
              ...
              <div className="space-y-3">
                <div className="text-sm font-bold">Interactive Preview</div>
                <div className="p-8 rounded-chellaa-lg border border-border bg-card max-w-xl mx-auto space-y-4">
              ...
              <div className="space-y-3">
                ...
                <div className="relative rounded-chellaa-lg bg-muted/60 border border-border p-4 font-mono text-xs text-foreground">
                  <pre className="overflow-x-auto">
{`import { useState } from "react";
import { Drawer, Button, Input, Switch } from "@chellaa/ui";
          ...
          {activeSection === "alert" && (
            <div className="space-y-8">
              ...
              <div className="space-y-3">
                ...
                <div className="relative rounded-chellaa-lg bg-muted/60 border border-border p-4 font-mono text-xs text-foreground">
                  <pre className="overflow-x-auto">
{`import { Alert, Button } from "@chellaa/ui";
          ...
          {activeSection === "form" && (
            <div className="space-y-8">
              ...
              <div className="space-y-3">
                ...
                <div className="relative rounded-chellaa-lg bg-muted/60 border border-border p-4 font-mono text-xs text-foreground">
                  <pre className="overflow-x-auto">
{`import { Form, FormField, Input, Button } from "@chellaa/ui";
          ...
          {activeSection === "breadcrumb" && (
            <div className="space-y-8">
              ...
              <div className="space-y-3">
                ...
                <div className="relative rounded-chellaa-lg bg-muted/60 border border-border p-4 font-mono text-xs text-foreground">
                  <pre className="overflow-x-auto">
{`import { Breadcrumb } from "@chellaa/ui";
  ...
  return (
    <Breadcrumb separator="/">
      <Breadcrumb.List>
        ...
        <Breadcrumb.Separator />
        <Breadcrumb.Item>
          <Breadcrumb.Page>Chellaa UI</Breadcrumb.Page>
        </Breadcrumb.Item>
      </Breadcrumb.List>
    </Breadcrumb>
  );
          ...
          {activeSection === "divider" && (
            <div className="space-y-8">
              ...
              <div className="space-y-3">
                ...
                <div className="p-8 rounded-chellaa-lg border border-border bg-card max-w-xl mx-auto space-y-6">
                  <div className="space-y-2">
                    ...
                    <div className="p-4 bg-muted/20 border border-border/70 rounded-chellaa-lg space-y-3">
              ...
              <div className="space-y-3">
                ...
                <div className="relative rounded-chellaa-lg bg-muted/60 border border-border p-4 font-mono text-xs text-foreground">
                  <pre className="overflow-x-auto">
{`import { Divider, Button } from "@chellaa/ui";
              ...
              <div className="space-y-3">
                ...
                <div className="p-8 rounded-chellaa-lg border border-border bg-card max-w-xl mx-auto space-y-6">
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-4 p-4 bg-muted/20 border border-border/70 rounded-chellaa-lg">
                      <Spinner size="xs" />
                      <Spinner size="small" />
                      <Spinner size="medium" />
                      <Spinner size="large" />
        ...
        <Button variant="outline">Read Documentation</Button>
          ...
          {activeSection === "statcard" && (
            <div className="space-y-8">
              ...
              <div className="space-y-3">
                <div className="text-sm font-bold">Interactive Preview</div>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 p-8 rounded-chellaa-lg border border-border bg-card max-w-2xl mx-auto">
                  <StatCard
                    variant="elevated"
                    hoverable
              ...
              <div className="space-y-3">
                ...
                <div className="p-8 rounded-chellaa-lg border border-border bg-card max-w-xl mx-auto space-y-6">
                  <div className="space-y-3">
                    ...
                    <div className="space-y-2.5 p-4 bg-muted/20 border border-border/70 rounded-chellaa-lg">
                      <div className="flex items-center justify-between text-xs">
                  ...
                  <div className="space-y-3 pt-3 border-t border-border">
                    ...
                    <div className="flex items-center justify-between gap-2 p-4 bg-muted/20 border border-border/70 rounded-chellaa-lg">
                      <Kbd size="xs">XS</Kbd>
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-3">
                ...
                <div className="p-8 rounded-chellaa-lg border border-border bg-card max-w-xl mx-auto space-y-6">
                  <div className="space-y-2">
                    <div className="text-xs font-semibold text-muted-foreground">1. Semantic Variants:</div>
                    <div className="flex flex-wrap items-center gap-2 p-4 bg-muted/20 border border-border/70 rounded-chellaa-lg">
              ...
              <div className="space-y-3">
                ...
                <div className="p-6 rounded-chellaa-lg border border-border bg-card space-y-4">
                  <Banner
                    ...
                    closable
                  >
                    Chellaa UI v1.0 is officially released with 33 production primitives!
                  </Banner>
              ...
              <div className="space-y-3">
                ...
                <div className="p-8 rounded-chellaa-lg border border-border bg-card max-w-xl mx-auto space-y-6">
                  <div className="space-y-3">
                    ...
                    <div className="p-4 bg-muted/20 border border-border/70 rounded-chellaa-lg flex items-center justify-between">
          ...
          {activeSection === "command" && (
            <div className="space-y-8">
              ...
              <div className="space-y-3">
                ...
                <div className="relative rounded-chellaa-lg bg-muted/60 border border-border p-4 font-mono text-xs text-foreground">
                  <pre className="overflow-x-auto">
{`import { Command } from "@chellaa/ui";
