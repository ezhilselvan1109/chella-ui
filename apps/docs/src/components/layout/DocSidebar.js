...
export const DocSidebar = ({ activeSection, onSelectSection, isMobileOpen, onCloseMobile, }) => {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("aside", { className: "hidden md:block w-64 shrink-0 border-r border-border bg-card/40 h-[calc(100vh-53px)] sticky top-[53px]", children: navContent }), isMobileOpen && (_jsxs("div", { className: "fixed inset-0 z-50 md:hidden flex", children: [_jsx("div", { className: "fixed inset-0 bg-background/80 backdrop-blur-sm transition-opacity animate-in fade-in-0 duration-200", onClick: onCloseMobile }), _jsxs("div", { className: "relative w-4/5 max-w-xs bg-card border-r border-border h-full shadow-2xl z-10 flex flex-col animate-in slide-in-from-left duration-200", children: [_jsxs("div", { className: "p-3.5 border-b border-border flex items-center justify-between", children: [_jsx("span", { className: "font-extrabold text-sm text-foreground", children: "Navigation" }), _jsx("button", { type: "button", onClick: onCloseMobile, className: "p-1.5 rounded-chellaa-md text-muted-foreground hover:text-foreground hover:bg-muted", "aria-label": "Close Navigation", children: _jsx(X, { className: "w-4 h-4" }) })] }), _jsx("div", { className: "flex-1 overflow-y-auto pt-2", children: navContent })] })] }))] }));
};
