...
const initialCustomers: CustomerRecord[] = [
  { id: "1", name: "Kumar Selvan", email: "kumar@chellaa.dev", role: "Frontend Lead", status: "active", revenue: 8450 },
  { id: "2", name: "Ravi Chandran", email: "ravi@chellaa.dev", role: "Backend Architect", status: "active", revenue: 6200 },
  { id: "3", name: "Anand Raj", email: "anand@chellaa.dev", role: "Product Designer", status: "pending", revenue: 3900 },
  { id: "4", name: "Deepa Narayanan", email: "deepa@chellaa.dev", role: "QA Engineer", status: "inactive", revenue: 1500 },
];

const PRESET_PALETTES = [
  { name: "Chellaa Blue", primary: "221.2 83.2% 53.3%", radius: "0.5rem" },
...
export default function App() {
  ...
  // Token customizer
  const [activePreset, setActivePreset] = useState("Chellaa Blue");
    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col font-sans transition-colors duration-200 antialiased">
      ...
      <header className="sticky top-0 z-40 border-b border-border/80 bg-background/80 backdrop-blur-md px-6 sm:px-8 py-3.5 flex items-center justify-between shadow-xs">
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-chellaa-md bg-primary text-primary-foreground flex items-center justify-center shadow-md font-black text-lg">
            C
          </div>
          <div>
            <div className="flex items-center gap-2.5">
              <span className="text-lg font-extrabold tracking-tight">Chellaa UI</span>
        ...
        <div className="flex items-center gap-3 sm:gap-4">
          <div className="hidden md:flex items-center bg-muted/60 p-1 rounded-chellaa-md border border-border/70">
            <button
              onClick={() => setActiveTab("overview")}
              className={`px-3.5 py-1 text-xs font-semibold rounded-chellaa-sm transition-all ${
                activeTab === "overview"
          ...
          <div className="flex items-center bg-muted/60 p-1 rounded-chellaa-md border border-border/70">
            <button
              type="button"
              onClick={() => setTheme("light")}
              title="Light Mode"
              className={`p-1.5 rounded-chellaa-sm transition-all ${
      ...
      <Banner
        ...
        closable
      >
        Chellaa UI Component Library is loaded with 33 production-ready components and full keyboard accessibility.
      </Banner>
        ...
        <section className="relative overflow-hidden rounded-2xl border border-border/80 bg-gradient-to-br from-primary/10 via-card to-background p-6 sm:p-10 shadow-xs">
          <div className="max-w-2xl space-y-4">
            ...
            <p className="text-muted-foreground text-sm sm:text-base leading-relaxed">
              Test and configure Chellaa UI components in real time. Switch themes, adjust brand color palettes, tweak border radius, and verify accessibility focus flows.
            </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 items-start">
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {PRESET_PALETTES.map((preset) => (
                      <button
                        ...
                        className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-chellaa-md text-xs font-medium border transition-all ${
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {["0.25rem", "0.5rem", "0.75rem", "1rem"].map((r) => (
                      <button
                        ...
                        className={`px-3 py-1.5 text-xs font-medium rounded-chellaa-md border transition-all ${
                          customRadius === r
                ...
                <div className="space-y-2.5">
                  ...
                  <div className="flex items-center gap-2 pt-0.5">
                    <div className="w-7 h-7 rounded-chellaa-md bg-primary shadow-xs border border-white/20" title="Primary" />
                    <div className="w-7 h-7 rounded-chellaa-md bg-secondary shadow-xs border border-border" title="Secondary" />
                    <div className="w-7 h-7 rounded-chellaa-md bg-success shadow-xs border border-white/20" title="Success" />
                    <div className="w-7 h-7 rounded-chellaa-md bg-warning shadow-xs border border-white/20" title="Warning" />
                    <div className="w-7 h-7 rounded-chellaa-md bg-danger shadow-xs border border-white/20" title="Danger" />
                    <div className="w-7 h-7 rounded-chellaa-md bg-card shadow-xs border border-border" title="Card" />
                  </div>
                </div>
                ...
                <div className="space-y-2.5">
                  ...
                  <div className="flex items-center gap-2 text-xs text-emerald-600 dark:text-emerald-400 font-semibold bg-emerald-500/10 p-2.5 rounded-chellaa-md border border-emerald-500/20">
          ...
          <Card variant="outlined" className="border-border/80 shadow-xs">
            ...
            <Card.Content className="p-6 space-y-6">
              ...
              <div className="space-y-2.5 pt-2">
                ...
                <div className="p-3.5 bg-muted/20 border border-border/70 rounded-chellaa-lg space-y-3">
              ...
              <div className="space-y-2.5 pt-2">
                ...
                <div className="p-3 bg-muted/20 border border-border/70 rounded-chellaa-lg">
                  <Breadcrumb
                    items={[
                      { label: "Console", href: "#" },
              ...
              <div className="space-y-2.5 pt-2">
                ...
                <div className="flex flex-wrap items-center justify-between gap-4 p-3 bg-muted/20 border border-border/70 rounded-chellaa-lg">
                  <div className="flex items-center gap-2.5">
              ...
              <div className="space-y-2.5 pt-2">
                ...
                <div className="p-3 bg-muted/20 border border-border/70 rounded-chellaa-lg space-y-2.5">
                  <div className="flex items-center gap-3">
              ...
              <div className="space-y-2.5 pt-2">
                ...
                <div className="flex items-center justify-between p-3.5 bg-muted/20 border border-border/70 rounded-chellaa-lg">
                  <div className="flex items-center gap-3">
              ...
              <div className="space-y-2.5 pt-2">
                ...
                <div className="p-3.5 bg-muted/20 border border-border/70 rounded-chellaa-lg">
          ...
          <Card variant="outlined" className="border-border/80 shadow-xs">
            ...
            <Card.Content className="p-6 space-y-6">
              ...
              <div className="space-y-3 pt-4 border-t border-border/70">
                ...
                <div className="flex items-center justify-between p-3 bg-muted/20 border border-border/70 rounded-chellaa-lg">
      ...
      <Modal
        ...
        description="Fill out the team member details to grant access to the Chellaa UI workspace."
        footer={
          <>
      ...
      <footer className="mt-auto border-t border-border/80 bg-card py-6 text-center text-xs text-muted-foreground">
        Chellaa UI • Production-Grade React Component Library with Tailwind CSS & Design Tokens • MIT License
      </footer>
    </div>
  );
}
