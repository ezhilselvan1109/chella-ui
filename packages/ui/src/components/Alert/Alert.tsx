      ...
      >
        ...
        {closable && (
          <button
            ...
            className="shrink-0 rounded-chellaa-md p-1 opacity-70 hover:opacity-100 hover:bg-black/10 dark:hover:bg-white/10 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
          >
