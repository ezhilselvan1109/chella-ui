...
export const bannerCloseButtonVariants = cva(
  "inline-flex items-center justify-center rounded-chellaa-sm p-1 hover:bg-black/10 dark:hover:bg-white/10 text-current transition-colors shrink-0 focus:outline-hidden focus-visible:ring-1 focus-visible:ring-ring"
);
