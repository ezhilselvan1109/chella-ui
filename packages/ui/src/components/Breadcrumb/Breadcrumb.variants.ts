...
export const breadcrumbLinkVariants = cva(
  "transition-colors hover:text-foreground focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring rounded-xs"
);

export const breadcrumbPageVariants = cva("font-medium text-foreground cursor-default");

export const breadcrumbSeparatorVariants = cva(
  "text-muted-foreground/60 shrink-0 [&>svg]:size-3.5"
);
