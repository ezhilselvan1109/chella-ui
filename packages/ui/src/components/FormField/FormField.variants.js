...
export const formLabelVariants = cva("chellaa-form-field-label block font-semibold text-foreground select-none cursor-pointer transition-colors leading-tight", {
    variants: {
        size: {
            small: "text-xs",
