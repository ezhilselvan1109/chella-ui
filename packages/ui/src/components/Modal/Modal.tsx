    ...
    <ModalContext.Provider value={contextValue}>
      ...
      >
        ...
        >
          ...
          {footer && (
            <div className="flex items-center justify-end gap-3 p-6 pt-3 border-t border-border bg-muted/20 rounded-b-chella-lg">
              {footer}
            </div>
          )}
        </div>
...
export function ModalFooter({ children, className }: { children: ReactNode; className?: string }) {
  return (
    <div
      className={cn(
        "flex items-center justify-end gap-3 p-6 pt-3 border-t border-border bg-muted/20 rounded-b-chella-lg",
        className
      )}
    >
      {children}
