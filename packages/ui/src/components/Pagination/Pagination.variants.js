...
export const paginationItemVariants = cva("inline-flex items-center justify-center font-medium rounded-chellaa-md transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-40 cursor-pointer", {
    variants: {
        variant: {
...
export const paginationEllipsisVariants = cva("inline-flex items-center justify-center text-muted-foreground h-8 w-8");
