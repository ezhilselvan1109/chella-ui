          ...
          >
            {showCloseButton && (
              <button
                ...
                className="absolute top-3 right-3 p-1 rounded-chellaa-sm text-muted-foreground hover:text-foreground hover:bg-muted transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-ring"
              >
