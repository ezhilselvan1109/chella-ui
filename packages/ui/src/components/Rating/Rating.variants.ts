...
export const ratingItemVariants = cva(
  "inline-flex items-center justify-center p-0.5 rounded-chellaa-sm transition-all focus:outline-hidden focus-visible:ring-2 focus-visible:ring-ring cursor-pointer",
  {
    variants: {
      color: {
