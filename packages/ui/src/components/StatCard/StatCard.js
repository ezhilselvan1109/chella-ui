...
export const StatCardIcon = forwardRef(({ className, children, ...props }, ref) => {
    return (_jsx("div", { ref: ref, "aria-hidden": "true", className: cn("p-2 rounded-chellaa-md bg-primary/10 text-primary shrink-0 [&>svg]:size-4", className), ...props, children: children }));
});
