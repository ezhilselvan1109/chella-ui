...
describe("Switch Component", () => {
  ...
  it("renders with label prop and toggles when label is clicked", async () => {
    ...
    render(<Switch label="Enable Push Notifications" />);
  ...
  it("renders label passed as children", async () => {
    const user = userEvent.setup();
    render(<Switch>Auto-Save Progress</Switch>);
  ...
  it("associates description via aria-describedby", () => {
    render(
      <Switch
        label="Weekly Digest"
        description="Receive weekly summaries of team activities."
      />
    );
  ...
  it("associates error message and sets aria-invalid", () => {
    render(
      <Switch
        label="Cloud Backup"
        error="Storage quota exceeded for cloud backup."
      />
    );
  ...
  it("supports small, medium, and large sizes", () => {
    const { container: smallContainer } = render(<Switch size="small" label="Small" />);
    const { container: largeContainer } = render(<Switch size="large" label="Large" />);
  ...
  it("merges custom className onto root container", () => {
    const { container } = render(<Switch className="custom-switch-container" label="Styled" />);
