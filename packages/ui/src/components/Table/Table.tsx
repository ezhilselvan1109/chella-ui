...
export function Table<T extends object = Record<string, unknown>>({
  ...
  return (
    <div className="w-full overflow-x-auto rounded-chellaa-lg border border-border bg-card shadow-xs">
            ...
            {rowSelection && (
              <th className="w-12 text-center">
                <input
                  ...
                  className="rounded-chellaa-sm border-input text-primary focus:ring-primary h-4 w-4 cursor-pointer"
                />
              </th>
            )}
