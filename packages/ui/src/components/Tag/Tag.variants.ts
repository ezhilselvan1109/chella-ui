...
export const tagVariants = cva(
  "inline-flex items-center font-sans font-medium transition-all select-none border border-transparent shrink-0 leading-none",
  {
    variants: {
      variant: {
...
export const tagCloseButtonVariants = cva(
  "inline-flex items-center justify-center rounded-full p-0.5 hover:bg-black/10 dark:hover:bg-white/10 text-current transition-colors focus:outline-hidden focus-visible:ring-1 focus-visible:ring-ring"
);
