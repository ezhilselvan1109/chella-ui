...
export const tooltipContentVariants = cva(
  "z-50 overflow-hidden rounded-chellaa-sm px-2.5 py-1 text-xs font-medium shadow-md transition-all duration-150 animate-in fade-in-0 zoom-in-95 pointer-events-none select-none font-sans",
  {
    variants: {
      variant: {
