    ...
    <div className="w-[500px]">
      <Accordion type="single" collapsible defaultValue="item-1">
        <Accordion.Item value="item-1">
          ...
          <Accordion.Content>
            Chella UI is a high-performance React design system inspired by Ant Design, Material UI, and Radix UI, styled with Tailwind CSS tokens.
          </Accordion.Content>
        </Accordion.Item>
        ...
        <Accordion.Item value="item-3">
          <Accordion.Trigger>Is Chella UI fully accessible?</Accordion.Trigger>
          <Accordion.Content>
