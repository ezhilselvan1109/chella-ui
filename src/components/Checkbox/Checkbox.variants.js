...
export const checkboxBoxVariants = cva("relative inline-flex items-center justify-center shrink-0 border transition-all select-none rounded-chella-sm font-medium", {
    variants: {
        size: {
            small: "w-3.5 h-3.5",
            medium: "w-4 h-4",
