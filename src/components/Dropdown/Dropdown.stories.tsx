...
export const IconTrigger: Story = {
  render: () => (
    <Dropdown
      ...
      trigger={
        <button className="p-2 rounded-chella-md text-muted-foreground hover:text-foreground hover:bg-muted transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-ring">
