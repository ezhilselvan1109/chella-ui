...
export const kbdVariants = cva("inline-flex items-center justify-center font-mono font-medium rounded-chella-sm select-none border transition-colors leading-none", {
    variants: {
        variant: {
