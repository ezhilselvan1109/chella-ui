...
export function ModalFooter({ children, className }) {
    return (_jsx("div", { className: cn("flex items-center justify-end gap-3 p-6 pt-3 border-t border-border bg-muted/20 rounded-b-chella-lg", className), children: children }));
}
