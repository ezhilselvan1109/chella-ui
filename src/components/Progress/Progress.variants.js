...
export const progressTrackVariants = cva("w-full overflow-hidden rounded-full bg-muted select-none font-sans", {
    variants: {
        size: {
            small: "h-1.5",
            medium: "h-2.5",
...
export const progressIndicatorVariants = cva("h-full rounded-full transition-all duration-300 ease-out", {
    variants: {
        variant: {
            default: "bg-primary",
            success: "bg-success",
