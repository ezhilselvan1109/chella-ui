...
export const selectDropdownVariants = cva(
  "absolute z-50 w-full mt-1.5 max-h-60 overflow-auto rounded-chella-md border border-border bg-popover text-popover-foreground shadow-lg animate-fade-in p-1 focus:outline-none"
);

export const selectOptionVariants = cva(
  "relative flex items-center justify-between w-full px-2.5 py-2 text-sm rounded-chella-sm cursor-pointer select-none transition-colors outline-none",
  {
    variants: {
      isSelected: {
