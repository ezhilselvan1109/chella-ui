...
export const textareaVariants = cva(
  "w-full rounded-chella-md text-foreground placeholder:text-muted-foreground transition-all duration-150 outline-none disabled:cursor-not-allowed disabled:opacity-50 font-sans",
  {
    variants: {
      variant: {
        default:
