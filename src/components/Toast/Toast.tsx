      ...
      >
        ...
        {onClose && (
          <button
            ...
            className="shrink-0 p-1 rounded-chella-sm text-muted-foreground hover:text-foreground hover:bg-muted transition-colors focus:outline-none focus-visible:ring-1 focus-visible:ring-ring"
          >
