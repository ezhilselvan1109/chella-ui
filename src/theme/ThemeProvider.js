...
export function ThemeProvider({ children, defaultTheme = "system", storageKey = "chella-theme", theme: themeConfig, }) {
...
export function useTheme() {
    ...
    if (!context) {
        throw new Error("useTheme must be used within a Chella UI ThemeProvider");
    }
    return context;
}
