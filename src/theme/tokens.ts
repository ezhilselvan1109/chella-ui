import type { CustomThemeTokens } from "./theme.types";

export const defaultLightTokens: CustomThemeTokens = {
...
export const defaultDarkTokens: CustomThemeTokens = {
...
const tokenToCssVariableMap: Record<keyof CustomThemeTokens, string> = {
...
export function applyTokensToElement(
  ...
  for (const [key, value] of Object.entries(tokens)) {
    const cssVar = tokenToCssVariableMap[key as keyof CustomThemeTokens];
